...
class SignUp extends Form {
  ...
  takes copt of the user data and add premium parameter as "false" (regular user signup) (premium required by backend schema)
            ...
            <div className="row ">
              <div className="col-12">
                ...
                >
                  ...
                  <Link
                    to="/signin"
                    style={({ marginBottom: '10px' }, { paddingLeft: '35px' })}
                  >
